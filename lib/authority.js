...
Authority.prototype._createInstanceDiscoveryEndpointFromTemplate = function(authorityHost) {
  ...
  discoveryEndpoint = discoveryEndpoint.replace('{authorize_host}', util.newSubstrSafe(authorityHost));
  discoveryEndpoint = discoveryEndpoint.replace('{authorize_endpoint}', util.newSubstrSafe(encodeURIComponent(this._createAuthorityUrl())));
