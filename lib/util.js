...
/**
* Prepares a string for use as the second argument to String#replace.
* @see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/replace#Specifying_a_string_as_a_parameter
* @static
* @memberOf Util
* @param {string} newSubstr   The original newSubstr.
* @returns {function}         A function that always returns newSubstr.
*/
function newSubstrSafe(newSubstr) {
  return function () {
    return newSubstr;
  };
}
...
module.exports.newSubstrSafe = newSubstrSafe;
